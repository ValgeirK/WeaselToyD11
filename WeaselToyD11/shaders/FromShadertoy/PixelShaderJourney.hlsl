...
#if COLOR_SCHEME == 0
static const float _FogMul = -0.00100 ;
static const float _FogPow = 1.82000 ;
static const float _IncorrectGammaCorrect = 1.00000 ;
static const vec3 _LightDir = vec3(-0.22632, 0.88099, -0.4155) ;
static const float _Brightness = 1.00000 ;
static const float _Contrast = 1.00000 ;
static const float _Saturation = 1.00000 ;
static const vec3 _SunStar = vec3(14.7, 1.47, 0.1) ;
static const float _SunSize = 26.00000 ;
static const float _SunScale = 15.00000 ;
static const float _ExposureOffset = 11.10000 ;
static const float _ExposurePower = 0.52000 ;
static const float _ExposureStrength = 0.09000 ;
static const RGB _SunColor = RGB(1, 0.73741, 0.63971) ;
static const RGB _Zenith = RGB(0.67128, 0.94118, 0.69204) ;
static const float _ZenithFallOff = 1.42000 ;
static const RGB _Nadir = RGB(0, 0, 0) ;
static const float _NadirFallOff = 1.91000 ;
static const RGB _Horizon = RGB(0.80147, 0.80147, 0.80147) ;
static const vec3 _CharacterAOParams = vec3(0.03, 7.36, 0) ;
static const RGB _CharacterMainColor = RGB(0.57353, 0.1488, 0.067474) ;
static const RGB _CharacterTerrainCol = RGB(0.375, 0.21885, 0.15993) ;
static const RGB _CharacterCloakDarkColor = RGB(0.38971, 0.10735, 0.054444) ;
static const RGB _CharacterYellowColor = RGB(0.64706, 0.35588, 0) ;
static const RGB _CharacterWhiteColor = RGB(1, 1, 1) ;
static const float _CharacterBloomScale = 0.87000 ;
static const float _CharacterDiffScale = 1.50000 ;
static const float _CharacterFreScale = 1.77000 ;
static const float _CharacterFrePower = 3.84000 ;
static const float _CharacterFogScale = 20.00000 ;
static const float _CloudTransparencyMul = 0.90000 ;
static const RGB _CloudCol = RGB(1, 0.96957, 0.88235) ;
static const RGB _BackCloudCol = RGB(0.66176, 0.64807, 0.62284) ;
static const RGB _CloudSpecCol = RGB(0.17647, 0.062284, 0.062284) ;
static const RGB _BackCloudSpecCol = RGB(0.11029, 0.05193, 0.020275) ;
static const float _CloudFogStrength = 0.50000 ;
static const RGB _TombMainColor = RGB(0.47735, 0.59559, 0.49705) ;
static const RGB _TombScarfColor = RGB(0.45588, 0.093858, 0.093858) ;
static const RGB _PyramidCol = RGB(0.30147, 0.28329, 0.21059) ;
static const vec2 _PyramidHeightFog = vec2(38.66, 1.05) ;
static const RGB _TerrainCol = RGB(0.76863, 0.55294, 0.47059) ;
static const RGB _TerrainSpecColor = RGB(0.32353, 0.32123, 0.31877) ;
static const float _TerrainSpecPower = 55.35000 ;
static const float _TerrainSpecStrength = 1.56000 ;
static const float _TerrainGlitterRep = 7.00000 ;
static const float _TerrainGlitterPower = 1.94000 ;
static const RGB _TerrainRimColor = RGB(0, 0, 0) ;
static const float _TerrainRimPower = 5.59000 ;
static const float _TerrainRimStrength = 2.00000 ;
static const float _TerrainRimSpecPower = 1.46000 ;
static const float _TerrainFogPower = 2.11000 ;
static const vec4 _TerrainShadowParams = vec4(0.12, 5.2, 88.7, 0.28) ;
static const vec3 _TerrainAOParams = vec3(0.01, 0.02, 2) ;
static const RGB _TerrainShadowColor = RGB(0.40441, 0.34106, 0.31818) ;
static const RGB _TerrainDistanceShadowColor = RGB(1, 0.81471, 0.74265) ;
static const float _TerrainDistanceShadowPower = 0.11000 ;
static const RGB _FlyingHelperMainColor = RGB(0.80882, 0.11671, 0.017842) ;
static const RGB _FlyingHelperCloakDarkColor = RGB(1, 0.090909, 0) ;
static const RGB _FlyingHelperYellowColor = RGB(1, 0.56187, 0.0073529) ;
static const RGB _FlyingHelperWhiteColor = RGB(1, 1, 1) ;
static const float _FlyingHelperBloomScale = 1.91000 ;
static const float _FlyingHelperFrePower = 1.00000 ;
static const float _FlyingHelperFreScale = 0.85000 ;
static const float _FlyingHelperFogScale = 4.00000 ;
#endif

#if COLOR_SCHEME == 1
static const float _FogMul = -0.00800 ;
static const float _FogPow = 1.00000 ;
static const float _IncorrectGammaCorrect = 1.00000 ;
static const vec3 _LightDir = vec3(-0.23047, 0.87328, -0.42927) ;
static const float _Brightness = 0.40000 ;
static const float _Contrast = 0.83000 ;
static const float _Saturation = 1.21000 ;
static const vec3 _SunStar = vec3(14.7, 1.47, 0.1) ;
static const float _SunSize = 26.00000 ;
static const float _SunScale = 15.00000 ;
static const float _ExposureOffset = 11.10000 ;
static const float _ExposurePower = 0.52000 ;
static const float _ExposureStrength = 0.09000 ;
static const RGB _SunColor = RGB(1, 0.95441, 0.77206) ;
static const RGB _Zenith = RGB(0.77941, 0.5898, 0.41263) ;
static const float _ZenithFallOff = 2.36000 ;
static const RGB _Nadir = RGB(1, 0.93103, 0) ;
static const float _NadirFallOff = 1.91000 ;
static const RGB _Horizon = RGB(0.96324, 0.80163, 0.38954) ;
static const vec3 _CharacterAOParams = vec3(0.03, 7.36, 0) ;
static const RGB _CharacterMainColor = RGB(0.60294, 0.1515, 0.062067) ;
static const RGB _CharacterTerrainCol = RGB(0.35294, 0.16016, 0.12197) ;
static const RGB _CharacterCloakDarkColor = RGB(0.25735, 0.028557, 0.0056769) ;
static const RGB _CharacterYellowColor = RGB(0.88971, 0.34975, 0) ;
static const RGB _CharacterWhiteColor = RGB(0.9928, 1, 0.47794) ;
static const float _CharacterBloomScale = 0.70000 ;
static const float _CharacterDiffScale = 1.50000 ;
static const float _CharacterFreScale = 1.77000 ;
static const float _CharacterFrePower = 3.84000 ;
static const float _CharacterFogScale = 4.55000 ;
static const float _CloudTransparencyMul = 0.90000 ;
static const RGB _CloudCol = RGB(1, 0.84926, 0.69853) ;
static const RGB _BackCloudCol = RGB(0.66176, 0.64807, 0.62284) ;
static const RGB _CloudSpecCol = RGB(0.17647, 0.062284, 0.062284) ;
static const RGB _BackCloudSpecCol = RGB(0.11029, 0.05193, 0.020275) ;
static const float _CloudFogStrength = 0.50000 ;
static const RGB _TombMainColor = RGB(0.64706, 0.38039, 0.27451) ;
static const RGB _TombScarfColor = RGB(0.38971, 0.10029, 0.10029) ;
static const RGB _PyramidCol = RGB(0.69853, 0.40389, 0.22086) ;
static const vec2 _PyramidHeightFog = vec2(38.66, 1.3) ;
static const RGB _TerrainCol = RGB(0.56618, 0.29249, 0.1915) ;
static const RGB _TerrainSpecColor = RGB(1, 0.77637, 0.53676) ;
static const float _TerrainSpecPower = 55.35000 ;
static const float _TerrainSpecStrength = 1.56000 ;
static const float _TerrainGlitterRep = 7.00000 ;
static const float _TerrainGlitterPower = 3.20000 ;
static const RGB _TerrainRimColor = RGB(0.16176, 0.13131, 0.098724) ;
static const float _TerrainRimPower = 5.59000 ;
static const float _TerrainRimStrength = 1.61000 ;
static const float _TerrainRimSpecPower = 2.88000 ;
static const float _TerrainFogPower = 2.11000 ;
static const vec4 _TerrainShadowParams = vec4(0.12, 5.2, 88.7, 0.28) ;
static const vec3 _TerrainAOParams = vec3(0.01, 0.02, 2) ;
static const RGB _TerrainShadowColor = RGB(0.48529, 0.13282, 0) ;
static const RGB _TerrainDistanceShadowColor = RGB(0.70588, 0.4644, 0.36851) ;
static const float _TerrainDistanceShadowPower = 0.11000 ;
static const RGB _FlyingHelperMainColor = RGB(0.85294, 0.11759, 0.012543) ;
static const RGB _FlyingHelperCloakDarkColor = RGB(1, 0.090909, 0) ;
static const RGB _FlyingHelperYellowColor = RGB(1, 0.3931, 0) ;
static const RGB _FlyingHelperWhiteColor = RGB(1, 1, 1) ;
static const float _FlyingHelperBloomScale = 2.61000 ;
static const float _FlyingHelperFrePower = 1.00000 ;
static const float _FlyingHelperFreScale = 0.85000 ;
static const float _FlyingHelperFogScale = 1.75000 ;
#endif

#if COLOR_SCHEME == 2
static const float _FogMul = -0.00100 ;
static const float _FogPow = 1.68000 ;
static const float _IncorrectGammaCorrect = 1.00000 ;
static const vec3 _LightDir = vec3(-0.23047, 0.87328, -0.42927) ;
static const float _Brightness = 0.40000 ;
static const float _Contrast = 0.82000 ;
static const float _Saturation = 1.21000 ;
static const vec3 _SunStar = vec3(14.7, 1.47, 0.1) ;
static const float _SunSize = 26.00000 ;
static const float _SunScale = 15.00000 ;
...
static const float _ExposurePower = 0.52000 ;
static const float _ExposureStrength = 0.09000 ;
static const RGB _SunColor = RGB(0.97059, 0.97059, 0.97059) ;
static const RGB _Zenith = RGB(0.98039, 0.83137, 0.53725) ;
static const float _ZenithFallOff = 2.36000 ;
static const RGB _Nadir = RGB(0, 0, 0) ;
static const float _NadirFallOff = 1.91000 ;
static const RGB _Horizon = RGB(0.84559, 0.77688, 0.6031) ;
static const vec3 _CharacterAOParams = vec3(0.03, 7.36, 0) ;
static const RGB _CharacterMainColor = RGB(0.60294, 0.1515, 0.062067) ;
static const RGB _CharacterTerrainCol = RGB(0.5, 0.3404, 0.12868) ;
static const RGB _CharacterCloakDarkColor = RGB(0.31618, 0.14042, 0.039522) ;
static const RGB _CharacterYellowColor = RGB(0.64706, 0.30233, 0) ;
static const RGB _CharacterWhiteColor = RGB(1, 1, 1) ;
static const float _CharacterBloomScale = 0.87000 ;
static const float _CharacterDiffScale = 1.50000 ;
static const float _CharacterFreScale = 1.77000 ;
static const float _CharacterFrePower = 3.84000 ;
static const float _CharacterFogScale = 12.47000 ;
static const float _CloudTransparencyMul = 0.80000 ;
static const RGB _CloudCol = RGB(0.99216, 0.9451, 0.76471) ;
static const RGB _BackCloudCol = RGB(0.66176, 0.64807, 0.62284) ;
static const RGB _CloudSpecCol = RGB(0.17647, 0.062284, 0.062284) ;
static const RGB _BackCloudSpecCol = RGB(0.11029, 0.05193, 0.020275) ;
static const float _CloudFogStrength = 0.50000 ;
static const RGB _TombMainColor = RGB(0.94118, 0.82759, 0.45675) ;
static const RGB _TombScarfColor = RGB(0.44118, 0.19989, 0.14922) ;
static const RGB _PyramidCol = RGB(0.92647, 0.73579, 0.3338) ;
static const vec2 _PyramidHeightFog = vec2(38.66, 4.65) ;
static const RGB _TerrainCol = RGB(0.71324, 0.5076, 0.236) ;
static const RGB _TerrainSpecColor = RGB(0.32353, 0.32123, 0.31877) ;
static const float _TerrainSpecPower = 55.35000 ;
static const float _TerrainSpecStrength = 0.03000 ;
static const float _TerrainGlitterRep = 7.00000 ;
static const float _TerrainGlitterPower = 3.20000 ;
static const RGB _TerrainRimColor = RGB(0, 0, 0) ;
static const float _TerrainRimPower = 5.59000 ;
static const float _TerrainRimStrength = 1.61000 ;
static const float _TerrainRimSpecPower = 0.38000 ;
static const float _TerrainFogPower = 2.11000 ;
static const vec4 _TerrainShadowParams = vec4(0.12, 5.2, 88.7, 0.28) ;
static const vec3 _TerrainAOParams = vec3(0.01, 0.02, 2) ;
static const RGB _TerrainShadowColor = RGB(0.66912, 0.52969, 0.369) ;
static const RGB _TerrainDistanceShadowColor = RGB(1, 0.75466, 0.43382) ;
static const float _TerrainDistanceShadowPower = 0.11000 ;
static const RGB _FlyingHelperMainColor = RGB(0.91912, 0.30412, 0.21626) ;
static const RGB _FlyingHelperCloakDarkColor = RGB(1, 0.090909, 0) ;
static const RGB _FlyingHelperYellowColor = RGB(0.98529, 0.60477, 0.12316) ;
static const RGB _FlyingHelperWhiteColor = RGB(1, 1, 1) ;
static const float _FlyingHelperBloomScale = 1.91000 ;
static const float _FlyingHelperFrePower = 1.00000 ;
static const float _FlyingHelperFreScale = 0.85000 ;
...
static const float _FogPow = 1.82000 ;
static const float _IncorrectGammaCorrect = 1.00000 ;
static const vec3 _LightDir = vec3(-0.29644, 0.6859, -0.66458) ;
static const float _Brightness = 1.00000 ;
static const float _Contrast = 1.00000 ;
static const float _Saturation = 1.00000 ;
static const vec3 _SunStar = vec3(20.45, 1.49, 0.5) ;
static const float _SunSize = 26.09000 ;
static const float _SunScale = 15.04000 ;
static const float _ExposureOffset = 13.72000 ;
static const float _ExposurePower = 0.60000 ;
static const float _ExposureStrength = 0.02000 ;
static const RGB _SunColor = RGB(0.51471, 0.79919, 1) ;
static const RGB _Zenith = RGB(0, 0.053922, 0.16176) ;
static const float _ZenithFallOff = 1.42000 ;
static const RGB _Nadir = RGB(0.21569, 0.2549, 0.36078) ;
static const float _NadirFallOff = 1.91000 ;
static const RGB _Horizon = RGB(0.35191, 0.30223, 0.47794) ;
static const vec3 _CharacterAOParams = vec3(0.03, 7.36, 0) ;
static const RGB _CharacterMainColor = RGB(0.36765, 0.097656, 0.045956) ;
static const RGB _CharacterTerrainCol = RGB(0.083261, 0.11379, 0.16176) ;
static const RGB _CharacterCloakDarkColor = RGB(0.073529, 0.011604, 0) ;
static const RGB _CharacterYellowColor = RGB(0.60294, 0.33162, 0) ;
static const RGB _CharacterWhiteColor = RGB(1, 1, 1) ;
static const float _CharacterBloomScale = 0.87000 ;
static const float _CharacterDiffScale = 1.50000 ;
static const float _CharacterFreScale = 1.77000 ;
static const float _CharacterFrePower = 19.83000 ;
static const float _CharacterFogScale = 60.00000 ;
static const float _CloudTransparencyMul = 0.90000 ;
static const RGB _CloudCol = RGB(0.0069204, 0.15969, 0.23529) ;
static const RGB _BackCloudCol = RGB(0, 0.10969, 0.15441) ;
static const RGB _CloudSpecCol = RGB(0.11765, 0.11765, 0.11765) ;
static const RGB _BackCloudSpecCol = RGB(0.080882, 0.080882, 0.080882) ;
static const float _CloudFogStrength = 0.50000 ;
static const RGB _TombMainColor = RGB(0.23789, 0.27707, 0.40441) ;
static const RGB _TombScarfColor = RGB(0.066176, 0, 0.034229) ;
static const RGB _PyramidCol = RGB(0, 0, 0) ;
static const vec2 _PyramidHeightFog = vec2(38.66, 1.92) ;
static const RGB _TerrainCol = RGB(0, 0.058832, 0.10294) ;
static const RGB _TerrainSpecColor = RGB(0.24622, 0.29188, 0.33824) ;
static const float _TerrainSpecPower = 55.35000 ;
static const float _TerrainSpecStrength = 1.56000 ;
static const float _TerrainGlitterRep = 7.00000 ;
static const float _TerrainGlitterPower = 1.94000 ;
static const RGB _TerrainRimColor = RGB(0.091021, 0.057093, 0.16176) ;
static const float _TerrainRimPower = 5.59000 ;
static const float _TerrainRimStrength = 2.00000 ;
static const float _TerrainRimSpecPower = 1.46000 ;
static const float _TerrainFogPower = 2.11000 ;
static const vec4 _TerrainShadowParams = vec4(0.12, 5.2, 88.7, 0.37) ;
static const vec3 _TerrainAOParams = vec3(0.01, 0.02, 2) ;
static const RGB _TerrainShadowColor = RGB(0.11029, 0.11029, 0.11029) ;
static const RGB _TerrainDistanceShadowColor = RGB(0.0034061, 0.073181, 0.15441) ;
static const float _TerrainDistanceShadowPower = 0.06000 ;
static const RGB _FlyingHelperMainColor = RGB(0.12661, 0.004109, 0.13971) ;
static const RGB _FlyingHelperCloakDarkColor = RGB(1, 0.090909, 0) ;
static const RGB _FlyingHelperYellowColor = RGB(0.48529, 0.2711, 0) ;
static const RGB _FlyingHelperWhiteColor = RGB(1, 1, 1) ;
static const float _FlyingHelperBloomScale = 1.91000 ;
static const float _FlyingHelperFrePower = 1.00000 ;
static const float _FlyingHelperFreScale = 0.85000 ;
static const float _FlyingHelperFogScale = 5.51000 ;
#endif
...
static const mat4 _CameraInvViewMatrix = mat4( 1, 0, 0, 1.04, 
0, 0.9684963, 0.2490279, 2.2, 
0, 0.2490279, -0.9684963, 18.6, 
0, 0, 0, 1 ) ;
static const vec3 _CameraFOV = vec3(1.038, 0.78984, -1) ;
static const vec3 _CameraPos = vec3(1.0, 2.2, 18.6) ;
static const vec4 _CameraMovement = vec4(0.15, 0.1, 0.2, 0.25) ;
 
static const vec3 _WindDirection = vec3(-0.27, -0.12, 0) ;
 
static const float _DrawDistance = 70.00000 ;
static const float _MaxSteps = 64.00000 ;
 
static const vec3 _SunPosition = vec3(0.2, 56, -40.1) ;
static const float _CharacterRotation = 0.17000 ;
static const vec3 _CharacterPosition = vec3(0.52, 2.35, 17.6) ;
static const vec3 _CharacterScale = vec3(0.4, 0.53, 0.38) ;
static const float _MainClothRotation = 0.30000 ;
static const vec3 _MainClothScale = vec3(0.3, 0.68, 0.31) ;
static const vec3 _MainClothPosition = vec3(0, -0.12, 0) ;
static const vec3 _MainClothBotCutPos = vec3(0, -0.52, 0) ;
static const vec3 _MainClothDetail = vec3(6, 0.04, 1.3) ;
static const float _HeadScarfRotation = -0.19000 ;
static const vec3 _HeadScarfPosition = vec3(-0.005, -0.16, -0.01) ;
static const vec3 _HeadScarfScale = vec3(0.18, 0.2, 0.03) ;
static const float _HeadRotationX = -0.30000 ;
static const float _HeadRotationY = 0.29000 ;
static const float _HeadRotationZ = 0.00000 ;
static const vec3 _HeadPos = vec3(0, -0.04, 0.01) ;
static const vec3 _LongScarfPos = vec3(0.01, -0.15, 0.09) ;
static const vec3 _LongScarfScale = vec3(0.05, 1.25, 0.001) ;
static const vec4 _LongScarfWindStrength = vec4(0.3, 4.52, 5.2, 0.02) ;
static const float _LongScarfRotX = 1.43000 ;
static const float _LongScarfMaxRad = 1.99000 ;
static const vec3 _FacePosition = vec3(0, -0.01, 0.05) ;
static const vec3 _FaceSize = vec3(0.038, 0.05, 0.03) ;
static const vec3 _UpperLeftLegA = vec3(-0.02, -0.37, 0.01) ;
static const vec3 _UpperLeftLegB = vec3(-0.02, -0.67, -0.059999) ;
static const vec3 _UpperLeftLegParams = vec3(0.026, 1, 1) ;
static const vec3 _LowerLeftLegA = vec3(-0.02, -0.67, -0.059999) ;
static const vec3 _LowerLeftLegB = vec3(-0.02, -0.77, 0.12) ;
static const vec3 _LowerLeftLegParams = vec3(0.028, 0.03, 0.01) ;
static const vec3 _UpperRightLegA = vec3(0.07, -0.5, 0.02) ;
static const vec3 _UpperRightLegB = vec3(0.07, -0.61, 0.09) ;
static const vec3 _UpperRightLegParams = vec3(0.026, 1, 1) ;
static const vec3 _LowerRightLegA = vec3(0.07, -0.61, 0.09) ;
static const vec3 _LowerRightLegB = vec3(0.07, -0.91, 0.22) ;
static const vec3 _LowerRightLegParams = vec3(0.028, 0.03, 0.01) ;
static const vec3 _BodyPos = vec3(0, -0.45, -0.03) ;
static const vec3 _CharacterTrailOffset = vec3(0.72, 0.01, 0.06) ;
static const vec3 _CharacterTrailScale = vec3(0.001, 0, 0.5) ;
static const vec3 _CharacterTrailWave = vec3(1.97, 0, 0.34) ;
static const vec2 _CharacterHeightTerrainMix = vec2(1.95, -30) ;
static const vec3 _CloudNoiseStrength = vec3(0.2, 0.16, 0.1) ;
static const vec3 _FrontCloudsPos = vec3(9.91, 8.6, -12.88) ;
static const vec3 _FrontCloudsOffsetA = vec3(-9.1, 3.04, 0) ;
static const vec3 _FrontCloudsOffsetB = vec3(-2.97, 3.72, -0.05) ;
static const vec3 _FrontCloudParams = vec3(5.02, 3.79, 5) ;
static const vec3 _FrontCloudParamsA = vec3(3.04, 0.16, 2) ;
static const vec3 _FrontCloudParamsB = vec3(1.34, 0.3, 3.15) ;
static const vec3 _BackCloudsPos = vec3(29.99, 13.61, -18.8) ;
static const vec3 _BackCloudsOffsetA = vec3(24.87, -1.49, 0) ;
static const vec3 _BackCloudParams = vec3(7.12, 4.26, 1.68) ;
static const vec3 _BackCloudParamsA = vec3(6.37, 2.23, 2.07) ;
static const vec3 _PlaneParams = vec3(7.64, 10.85, 3.76) ;
static const vec3 _CloudGlobalParams = vec3(0.123, 2.1, 0.5) ;
static const vec3 _CloudBackGlobalParams = vec3(0.16, 1.4, -0.01) ;
static const vec3 _CloudNormalMod = vec3(0.26, -0.13, 1.22) ;
static const float _CloudSpecPower = 24.04000 ;
static const float _CloudPyramidDistance = 0.14500 ;
static const vec3 _TombPosition = vec3(5, 5, 9.28) ;
static const vec3 _TombScale = vec3(0.07, 0.5, 0.006) ;
static const vec3 _TombBevelParams = vec3(0.44, 0.66, 0.01) ;
static const float _TombRepScale = 0.79000 ;
static const vec3 _TombCutOutScale = vec3(0.39, 0.06, -14.92) ;
static const vec3 _TombScarfOffset = vec3(0, 0.46, 0) ;
static const vec3 _TombScarfWindParams = vec3(-1.61, 6, 0.05) ;
static const vec3 _TombScarfScale = vec3(0.03, 0.002, 0.5) ;
static const float _TombScarfRot = -0.88000 ;
static const mat4 _TombScarfMat = mat4( 0.9362437, 0, -0.3513514, 0, 
  0, 1, 0, 0, 
  0.3513514, 0, 0.9362437, 0, 
  0, 0, 0, 1 ) ;
static const vec3 _PyramidPos = vec3(0, 10.9, -50) ;
static const vec3 _PyramidScale = vec3(34.1, 24.9, 18) ;
static const vec3 _PrismScale = vec3(1, 1.9, 1) ;
static const vec3 _PyramidNoisePrams = vec3(1.5, 1, 1) ;
static const vec3 _PrismEyeScale = vec3(0.7, 1.9, 51.5) ;
static const vec3 _PyramidEyeOffset = vec3(2.0, -4.9, 0) ;
static const float _PrismEyeWidth = 5.86000 ;
static const float _TerrainMaxDistance = 30.04000 ;
static const float _SmallDetailStrength = 0.00600 ;
static const vec3 _SmallWaveDetail = vec3(3.19, 16, 6.05) ;
static const vec2 _WindSpeed = vec2(2, 0.6) ;
static const float _MediumDetailStrength = 0.05000 ;
static const vec2 _MediumWaveDetail = vec2(2, 50) ;
static const vec3 _MediumWaveOffset = vec3(0.3, -2, 0.1) ;
static const vec2 _LargeWaveDetail = vec2(0.25, 0.73) ;
static const vec3 _LargeWavePowStre = vec3(0.6, 2.96, -2.08) ;
static const vec3 _LargeWaveOffset = vec3(-3.65, 4.41, -11.64) ;
static const vec3 _FlyingHelperPos = vec3(2.15, 4.68, 14.4) ;
static const vec3 _FlyingHelperScale = vec3(0.25, 0.001, 0.3) ;
static const vec3 _FlyingHelperMovement = vec3(0.44, 1.44, -2.98) ;
static const vec3 _FlyingHelperScarfScale = vec3(0.1, 0.001, 1.5) ;
static const vec3 _FlyingHelperScarfWindParams = vec3(-0.06, 0.31, 0.47) ;
static const vec3 _FlyingHelperScarfWindDetailParams = vec3(3.93, 0.005, -45.32) ;
static const vec3 _FlyingHelperSideScarfOffset = vec3(0.16, -0.01, 0) ;
static const vec3 _FlyingHelperSideScarfScale = vec3(0.06, 0.001, 0.8) ;
static const vec4 _FlyingScarfSideWindParams = vec4(2.46, -1.59, -0.05, 0.21) ;
...
vec3 noised( in vec2 x )
{
    ...
    float a = tx0.Load( iChannel0, (p+ivec2(0,0))&255, 0 ).x;
	float b = tx0.Load( iChannel0, (p+ivec2(1,0))&255, 0 ).x;
	float c = tx0.Load( iChannel0, (p+ivec2(0,1))&255, 0 ).x;
	float d = tx0.Load( iChannel0, (p+ivec2(1,1))&255, 0 ).x;
#else    
    // texture version    
    vec2 p = floor(x);
	float a = tx0.SampleLevel( iChannel0, (p+vec2(0.5,0.5))/256.0, 0.0 ).x;
	float b = tx0.SampleLevel( iChannel0, (p+vec2(1.5,0.5))/256.0, 0.0 ).x;
	float c = tx0.SampleLevel( iChannel0, (p+vec2(0.5,1.5))/256.0, 0.0 ).x;
	float d = tx0.SampleLevel( iChannel0, (p+vec2(1.5,1.5))/256.0, 0.0 ).x;
#endif
...
{ 
	...
	if( TEST_MAT_LESS (m, MAT_TERRAIN_TRAIL ) )
	{
	    ...
	    float textureGlitter  = tx1.SampleLevel(iChannel1,pos.xz * _TerrainGlitterRep, 2.2).x * 1.15;
